...
GRANT all privileges ON assignment2.Task TO dbadmin@localhost;



insert into user_info(fname, lname, phone_number, email, address, city, zip_code)values("James", "Ide", 133, "ide@flinders", "Middle of nowhere", "Adelaide", 5155);
